 ...
 * backend/ or frontend/) skip this and use the committed copy.
 */
...
const siblingFrontend = join(pkgRoot, "..", "frontend", "src", "lib", "feature-catalog.json");
if (existsSync(dirname(siblingFrontend))) {
  copyFileSync(repoRootCatalog, siblingFrontend);
}
